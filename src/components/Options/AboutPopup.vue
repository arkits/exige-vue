    ...
    <v-dialog v-model="dialog" scrollable width="500">
        ...
        <v-card outlined>
            <v-card-title class="blue">
                <v-list-item>
                    <v-list-item-content>
                        <v-list-item-title class="headline mb-1">About Exige</v-list-item-title>
                    </v-list-item-content>
                </v-list-item>
            </v-card-title>
            ...
            <v-card-text class="white--text">
                ...
                <center>
                    <v-btn class="text-none" color="primary" href="https://github.com/arkits/exige">View Exige on GitHub</v-btn>

                    <br />
                    <br />

                    <v-btn class="text-none" color="primary" href="https://github.com/arkits/">View ArKits on GitHub</v-btn>
                </center>
            </v-card-text>
        </v-card>
    </v-dialog>
